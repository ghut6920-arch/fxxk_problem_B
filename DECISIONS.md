...
Rejected: treating TR-014 or a later P1-A self-check as independent evaluation; opening C1/C2/formal slots from one rehearsal or a synthetic clock; rewriting these grades after seeing scores; C2/P4/P5, C1-BACK, parameter scans, invented-clock C1-SIM repeats, or figure-only reruns in this window; consuming a formal slot before the SR-002 gate list (P1-A/P1-B, named C0 end-to-end, verified simulator origin, stressed rehearsals, no unexplained deadline failure, no unknown accepts, independent challenge or recorded absence, RT-002 F1 strategic disposition plus Red Team recheck). A user-accepted deadline risk cannot be labelled Strategist approval or used to close RT-002. Paper must not use the SR-002 forbidden “independent evaluation” phrases.
