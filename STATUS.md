...
- `WI-011` is an evidence-only inventory of locally reachable P0 inputs. It supersedes the unreachable remote issuance in `prompts/TECH_LEAD_HANDOFF_WI-006.md` and does not reopen completed local `WI-006`. It does not authorize a P0 EXP SPEC, experiment execution, implementation, or push.
