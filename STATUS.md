...
- `WI-020` is `COMPLETE` at `7f4dfba66a1467da865e411c2aa03bbec2203843` (TR-023). `B_BASELINE_READY`. Live K=14/16; N not UI-reported. Unmerged, unpushed.
...
- WI-021 waits for Red Team. Do not implement 150/49 or C1. Ask the operator for UI N on the WI-020 practices if still visible. New tests cannot start after 17:30 Beijing 2026-09-13.
